$(document).ready(function() {
  ...
  "choices": ["alert:\"There's someone behind you.\"", "alert(There is someone behind you.);","var catQuestion = prompt(\"Are you a feline fanatic?\")", "popup(\"Are you a feline fanatic?\")"] ,
  ...
  "choices": ["if (dogs[0]) \n {alert(\"Congratulations, your fur baby is a \" = dogs)","alert(\"Congratulations, your fur baby is a \" + dogs[0]); \n alert(\"Congratulations, your fur baby is a \" + dogs[1]); \n alert(\"Congratulations, your fur baby is a \" + dogs[2]); \n alert(\"Congratulations, your fur baby is a \" + dogs[3]); \n alert(\"Congratulations, your fur baby is a \" + dogs[4]);","do { \n alert(\"Congratulations, your fur baby is a \" + dogs[i]\") \n while (i < 5); }","for (i = 0; i < dogs.length; i++) { \n alert(\"Congratulations, your fur baby is a \" + dogs[i]);}"],
  "correct": "for (i = 0; i < dogs.length; i++) { \n alert(\"Congratulations, your fur baby is a \" + dogs[i]);}"
  },
  ...
  "choices": ["function identify() { \n var ask = prompt(\"Please enter your name below.\");}","function identify (var ask = prompt{\"Please enter your name below.\")};)","function { var ask = prompt(\"Please enter your name below.\");} \n identify{};","function identify() { \n var ask = prompt(\"Please enter your name below.\");} \n identify();"],
  "correct": "function identify() { \n var ask = prompt(\"Please enter your name below.\");} \n identify();"
  },

  { "toAsk": "Which of the following correctly identifies the difference between parameters and arguments?",
  "choices": ["function(greeting) // greeting is the parameter \n greeting(\"Hi!\"); // \"Hi\" is the argument","function(greeting) {};// greeting is the argument \n greeting(\"Hi!\"); // \"Hi\" is the parameter","There is no difference between parameters and arguments.","arguments are properties of a function, while parameters are properties of a particular call to a function."],
  "correct": "function(greeting) // greeting is the parameter \n greeting(\"Hi!\"); // \"Hi\" is the argument"
  },
  ...
  "choices": ["var number = 3; \n function animal() { var species = \"bear\" // global variable \n number; // local variable","number = 3; \n function animal() { species = \"bear\" // local variable \n number; // global variable","var number = 3; \n function { var species = \"bear\" // local variable \n number; // global variable \n","var number = 3; \n function animal() { var species = \"bear\" // local variable \n number; // global variable }</br>"],
  "correct": " function animal() { species = \"bear\" // local variable \n number; // global variable"
  },
  ...
  "choices": ["var bear = {type:\"Polar\", coat:\"white\", habitat:\"North Pole\", drink:\"Cola\"}","var bear = new Object();\n bear.type=\"Polar\";\nbear.coat=\"white\";\nbear.habitat=\"North Pole\";\nbear.drink=\"Cola\";","function bear(type, coat, habitat, drink) { \n this.type =\"polar\";\nthis.coat=\"white\";\nthis.habitat=\"North Pole\";\nthis.drink=\"Cola\";}","new Object(bear) = this.polar;\nthis.white;\n this.NorthPole\nthis.Cola"],
  "correct": "function bear(type, coat, habitat, drink) { \n this.type =\"polar\";\nthis.coat=\"white\";\nthis.habitat=\"North Pole\";\nthis.drink=\"Cola\";}"
  },
  { "toAsk": "You want the object cat to inherit all the properties of the object mammal. What is one way to accomplish this?",
  "choices": ["var mammal = { fur: true } \n var cat = mammal.proto","var mammal = { fur: true }\n cat.proto = mammal","var cat = Object.create(mammal, fur)","var mammal = { fur: true } \n cat = Object.create(mammal)"],
  "correct": "var mammal = { fur: true } \n cat = Object.create(mammal)"
  },
  { "toAsk": "Choose the words that accurately complete the following statement: \n Elements, attributes and text represent _____________ of a tree in a document. These document components are ____________ in JavaScript.",
  "choices": ["nodes; objects","branches; functions","nodes; functions","branches; objects"],
  "correct": "nodes; objects"
  },
  { "toAsk": "You want to change < p id=\"ratDiet\">The rat only eats Wisconsin cheddar cheese.< / p >\n to \n < p id=\"ratDiet\">The rat only eats Vermont cheddar cheese.< / p > when a user mouses over the text. What is one way to accomplish this?",
  "choices": ["document.getElementById(\"ratDiet\").onMouseOver.innerHTML = \"The rat only eats Vermont cheddar cheese.\"","document.getElementById(\"ratDiet\").addEventListener = onMouseover.innerHTML(\"The rat only eats Vermont cheddar cheese.\");","document.getElementByTagName(\"ratDiet\").innerHTML.onMouseover = \"The rat only eats Vermont cheddar cheese.\"","document.getElementById(\"ratDiet\").addEventListener(\"mouseover\", function() { \n this.innerHTML = \"The rat only eats Vermont cheddar cheese.\" })"],
  "correct": "document.getElementById(\"ratDiet\").addEventListener(\"mouseover\", function() { \n this.innerHTML = \"The rat only eats Vermont cheddar cheese.\" })"
  },
  { "toAsk": "You want to select and change the contents of \n < p >The rat only eats Wisconsin cheddar cheese< /p >.\n Which method should you use?",
...
function askQuestion() {
  ...
  $("button.option").on("click", function(){
    ...
    if(questionsRemaining < 1){
      $("section#structure").html("<h1 class='score'>Total Correct = "+correct+"/"+(currentQuestion +1)+"</h1>");
      $(".status").hide();
